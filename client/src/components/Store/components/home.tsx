...
function home() {
    ...
    return (
        <Box id='box-product' className='ml-14 mr-14 mt-20 grid grid-cols-3 grid-rows-6 justify-items-center content-between  gap-20'  >
            <Box className='col-span-3  row-span-6  flex flex-row justify-center items-center  '>
                <Box>
            ...
            <Box className='col-span-3 row-auto pt-40'>
